import { shield } from '../utils/assets';
  ...
  return (
    <div className='bg-[#FFF2F3] rounded-2xl border-2 border-[#FFD1D6] shadow-[0px_10px_50px_rgba(0,0,0,0.1)] backdrop-blur-xl p-10 xl:mr-10 text-center flex flex-col justify-between'>
      ...
      <div className='flex justify-center mt-10'>
        <Image src={shield} alt={'tick'} height={229} width={225} />
      </div>
      ...
      <div className='mt-10'>
        ...
        {/* CTA Button */}
        <div className='mt-10'>
          <button className='xl:w-[60%] w-[100%] xl:max-w-[260px] flex items-center justify-center bg-white text-[#F71D3B] font-bold font-poppins text-[16px] md:text-[24px] leading-[16px] md:leading-[36px] px-4 py-4 rounded-full shadow-md'>
            Sign Up Now →
          </button>
        </div>
      </div>
