...
export default function BuyerFeatures() {
  return (
    <section className="mt-10 md:mt-20 py-10 text-center w-[98%] max-w-[1280px] mx-auto">
      {/* Hero Section */}
      ...
      <p className="mt-6 md:mt-10 text-gray-500 px-[16px] text-[#949191] font-poppins text-[16px] md:text-[24px] leading-[24px] md:leading-[32px] mx-auto">
