...
export default function CarouselCard({
  ...
  return (
    <div className="w-full relative md:col-span-2 h-[584px] md:h-[400px] xl:h-[584px] bg-gradient-to-t from-[#FC9CA8] to-[#FFF2F3] pt-6 md:p-10 px-10 shadow-lg rounded-[32px] flex flex-col md:flex-row justify-between items-center text-left">
      ...
      {/* Ipad */}
      <div className={`hidden md:block xl:hidden absolute right-16`}>
        <Image src={image} alt="mobileimage" width={200} height={600} />
      </div>
