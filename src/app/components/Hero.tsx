...
const Hero = () => {
  return (
    <div className="mt-40 md:mt-52 relative">
      ...
      {/* Tagline */}
      <h2 className="mt-4 text-[46px] md:text-[58px] lg:text-[68px] font-poppins font-semibold text-gray-800 leading-[51px] sm:leading-[72px] tracking-[-0.5px] text-center">
