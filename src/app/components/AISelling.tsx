...
export default function AISelling() {
  return (
    <div className="relative">
      <div className="h-40 bg-gradient-to-t from-[#FFF2F3] via-[#FFD1D6] to-white absolute z-0 top-[-100px] md:top-[-210px] xl:top-[70px] left-[-2px] w-screen mx-auto"></div>
      <section className="bg-white mt-[-50px] md:mt-[-145px] xl:mt-[132px] py-5 md:py-10 px-[16px] text-center rounded-t-[56px] relative z-10 w-screen">
        <div className="mt-16 mb-6 xl:mt-[240px] xl:mb-[200px] mx-auto">
