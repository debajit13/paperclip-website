...
export default function AISelling() {
  return (
    <section className="bg-white mt-[-145px] py-10 px-6 text-center rounded-t-[56px] z-50 w-screen">
      ...
      <p className="mt-10 text-gray-500 max-w-[90%] font-poppins text-[24px] leading-[32px] mx-auto">
        Keep the vibe fresh and lightly cheeky. Ensure each feature has a short
        description that ties directly to the emotional payoff (time saved, no
        hassle, feeling up-to-date and in control).
      </p>
