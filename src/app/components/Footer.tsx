  ...
  return (
    <section className="bg-white relative z-50 min-h-screen text-center flex flex-col items-center mt-[188px] md:mt-[250px] xl:pt-[462px] xl:mt-0">
      ...
      <motion.div
        ...
        className="px-[16px] md:max-w-5xl text-center"
      >
        ...
        <button className="w-[100%] md:max-w-[350px] mt-8 md:mt-16 bg-[#F71D3B] text-white py-[12px] px-[36px] rounded-[100px] font-[600] text-[16px] leading-[16px] md:text-[24px] md:leading-[36px] font-poppins">
          Try It On, Right Now →
        </button>
      </motion.div>
      ...
      <div
        ref={containerRef}
        className="mt-28 md:mt-[100px] xl:mt-[172px] pb-[170px] md:pb-[800px] w-full bg-gradient-to-b from-white via-[#FFF2F3] to-[#FFD1D6] flex flex-row justify-center"
      >
