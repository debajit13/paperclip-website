  ...
  return (
    <section className="bg-white min-h-screen text-center flex flex-col items-center mt-10">
      ...
      <div className="max-w-5xl text-center mt-16">
        ...
        <h2 className="text-2xl font-[600] text-[40px] leading-[56px] mt-6 font-poppins">
        ...
        <button className="mt-16 bg-red-500 text-white py-2 px-8 rounded-[100px] font-[600] text-[24px] leading-[36px] font-poppins">
          Try It On—Right Now →
        </button>
      </div>

      {/* Hero Image Section */}
      <div className="relative mt-60 w-full bg-gradient-to-b from-white via-[#FFF2F3] to-[#FFD1D6]">
        <Image
          src={mobile}
          alt="AI Mirror"
          width={663}
        ...
        />
        {/* Reflections */}
        <div className="absolute top-0 left-60 opacity-60">
          <Image
            src={frameLeft}
            alt="Reflection Left"
            width={237}
        ...
        <div className="absolute top-0 right-60 opacity-60">
          <Image
            src={frameRight}
