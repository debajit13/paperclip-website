...
const HomeCardsGrid = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12 mx-auto w-full">
      ...
      <div className="w-full relative md:col-span-2 md:h-[584px] bg-gradient-to-t from-[#FC9CA8] to-[#FFF2F3] pt-6 px-6 md:pb-6 rounded-[32px] shadow-lg flex flex-col md:flex-row md:items-center text-left">
        <div className="h-[80%] md:w-[40%] flex flex-col justify-between md:ml-6">
          ...
          <button className="mt-4 bg-white text-red-500 py-2 px-5 md:px-6 rounded-[100px] font-[600] text-[16px] md:text-[24px] leading-[16px] md:leading-[36px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:flex-row md:col-span-2">
        {/* Left Card */}
        <div className="relative md:h-[1016px] bg-gradient-to-t from-[#FC9CA8] to-[#FFF2F3] pt-6 px-6 md:pt-14 md:px-14 md:pb-14 rounded-[32px] shadow-lg flex flex-col flex-start text-left">
          <h3 className="text-red-500 font-[600] text-[16px] md:text-[20px] leading-[24px] md:leading-[28px] tracking-[2px] font-poppins">
            On-Model Previews
          </h3>
          <h4 className="font-[600] text-[32px] md:text-[40px] leading-[40px] md:leading-[56px] mt-10 text-wrap font-poppins">
          ...
          <button className="my-4 md:mt-20 w-full md:w-[60%] bg-white text-red-500 py-2 px-6 rounded-[100px] font-[600] font-poppins text-[16px] md:text-[24px] leading-[16px] md:leading-[36px] w-[50%]">
            See it IRL →
          </button>
        ...
        <div className="flex flex-col gap-6 flex-1 max-h-[1016px]">
          <div className="md:h-[508px] bg-gradient-to-t from-[#FC9CA8] to-[#FFF2F3] pt-6 px-6 md:pt-14 md:px-14 md:pb-14 rounded-[32px] shadow-lg flex flex-col flex-start text-left">
            <div>
              <h3 className="text-red-500 font-[600] text-[16px] md:text-[20px] leading-[24px] md:leading-[28px] tracking-[2px] font-poppins">
              ...
              <p className="text-gray-600 font-[500] leading-[16px] md:text-[24px] leading-[24px] md:leading-[36px] mt-4 font-poppins">
                No more nerve-racking waiting games or shady updates—your new
                treasure is on its way, complete with real-time tracking
              </p>
            </div>

            <button className="my-10 md:mt-20 md:mb-0 bg-white text-red-500 py-2 px-6 rounded-[100px] font-[600] font-poppins text-[16px] md:text-[24px] leading-[16px] md:leading-[36px] md:w-[50%]">
              Get It Shipped →
            </button>
          </div>
