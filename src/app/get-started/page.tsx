  ...
  return (
    <div className='mt-16 md:mt-44 xl:mt-0 overflow-hidden mx-auto'>
      ...
      <motion.div
        ...
        className='bg-white pt-[192px] pb-[72px] md:py-[120px] px-[24px] md:px-6 text-center rounded-t-[56px] z-0 w-screen'
      >
      ...
      <motion.div
        ...
        className='bg-white mt-[192px] md:mt-28 xl:mt-[296px] mb-[56px] md:mb-12 xl:mb-[120px] px-[24px] md:px-6 text-center rounded-t-[56px] z-0 w-screen mx-auto'
      >
      ...
      <motion.div
        ...
        className='bg-white mt-[192px] md:mt-28 xl:mt-[252px] mb-14 md:mb-16 xl:mb-[120px] px-[24px] md:px-6 text-center rounded-t-[56px] mx-auto'
      >
