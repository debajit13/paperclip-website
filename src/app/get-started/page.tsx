...
const GetStarted = () => {
  ...
  const isInView = useInView(toolsSectionRef);
  const getStartedRef = useRef(null);
  const isGetStartedInView = useInView(getStartedRef);
  ...
  return (
    <div className="mt-16 md:mt-44 xl:mt-0 overflow-hidden mx-auto">
      ...
      <motion.div
        ...
        className="bg-white pt-[192px] pb-[72px] md:pt-[200px] xl:py-[120px] px-[24px] md:px-6 text-center rounded-t-[56px] z-0 w-screen"
      >
      ...
      <motion.div
        ...
        initial={{ opacity: 0, y: 50 }}
        animate={{
          opacity: isGetStartedInView ? 1 : 0,
          y: isGetStartedInView ? 0 : 50,
        }}
        transition={{
          duration: 1,
          ease: "easeOut",
        }}
        className="bg-white mt-[192px] md:mt-[200px] xl:mt-[296px] mb-[56px] md:mb-12 xl:mb-[120px] px-[24px] md:px-6 text-center rounded-t-[56px] z-0 w-screen mx-auto"
      >
      ...
      <motion.div
        ...
        initial={{ opacity: 0, y: 50 }}
        animate={{
          opacity: isActionInView ? 1 : 0,
          y: isActionInView ? 0 : 50,
        }}
        transition={{
          duration: 1,
          ease: "easeOut",
        }}
        className="bg-white mt-[192px] md:mt-[200px] xl:mt-[252px] mb-14 md:mb-16 xl:mb-[120px] px-[24px] md:px-6 text-center rounded-t-[56px] mx-auto"
      >
